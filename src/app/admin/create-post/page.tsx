            ...
            >
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[10px] font-bold tracking-[0.22em] uppercase text-primary">Dr.Hogr Admin</span>
                </div>
                <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-foreground">
                  Create New Post
                </h1>
                <p className="text-xs mt-1 text-muted-foreground">
                  Publish news and updates to the Dr.hogr ghareeb website
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="px-6 py-6">
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          <div className="text-[11px] font-bold" style={{ color: "#1a2b20" }}>Dr.Hogr ghareeb</div>
